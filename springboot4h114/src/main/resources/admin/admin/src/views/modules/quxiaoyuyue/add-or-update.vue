<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="取消预约" prop="quxiaoyuyue">
          <el-select v-model="ruleForm.quxiaoyuyue" placeholder="请选择取消预约">
            <el-option
                v-for="(item,index) in quxiaoyuyueOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="取消预约" prop="quxiaoyuyue">
	      <el-input v-model="ruleForm.quxiaoyuyue"
                placeholder="取消预约" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  data() {
	...
	quxiaoyuyue : false,
      ...
      rules: {
          ...
          quxiaoyuyue: [
                { required: true, message: '取消预约不能为空', trigger: 'blur' },
          ],
      }
    };
  },
