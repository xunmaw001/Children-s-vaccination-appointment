  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.53);borderRadius:10px">
        <h1 class="h1" style="color:rgba(101, 126, 253, 1);fontSize:25px;">儿童预防接种预约微信小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.jianhurenxingming" class="input" type="text" placeholder="监护人姓名">
			   </div>
			 </div> -->
			<el-form-item label="监护人姓名" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.jianhurenxingming" autocomplete="off" placeholder="监护人姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			...
			<el-form-item label="儿童姓名" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.ertongxingming" autocomplete="off" placeholder="儿童姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			   <div class="label">接种编号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jiezhongbianhao" class="input" type="text" placeholder="接种编号">
			   </div>
			 </div> -->
			<el-form-item label="接种编号" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.jiezhongbianhao" autocomplete="off" placeholder="接种编号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
