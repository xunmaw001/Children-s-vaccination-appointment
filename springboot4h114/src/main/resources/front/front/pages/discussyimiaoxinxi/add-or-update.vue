	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`discussyimiaoxinxi`, this.ruleForm.id);
		...
		methods: {
			...
			async onSubmitTap() {
					...
					return
																																																																												...
																																																																												if(this.ruleForm.id){
					await this.$api.update(`discussyimiaoxinxi`, this.ruleForm);
				}else{
					await this.$api.add(`discussyimiaoxinxi`, this.ruleForm);
				}
				uni.setStorageSync('discussyimiaoxinxiCleanType',true);
